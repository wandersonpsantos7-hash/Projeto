...
public class calculadoraController {
	...
	private void initialize() {
		...
		/*
		 * O setOnAction aciona o evento do componente por exemplo: o click no botão ou
		 * o enter em um text field
		 */
		...
		/*
		 * adicionar um escutador de evento no text field de numero 1 ao digitar dentro
		 * do text fiel ele vai trocar a letra por uma informação vazia atravez do
		 * replaceAll
		 */
...
//metodo de converter string para double
	static double StrToDbl(String numero) {
		try {
